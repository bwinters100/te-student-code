...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "quiz_db_test");
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("quiz_db_test.sql"));
