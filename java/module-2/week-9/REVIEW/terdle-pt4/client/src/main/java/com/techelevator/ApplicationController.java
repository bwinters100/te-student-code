...
public class ApplicationController {
    ...
    private static final String[] MAIN_MENU_OPTIONS = {PLAY_RANDOM_GAME, SHOW_GAME_STATS, LOG_OUT, EXIT};
    private static final String[] MAIN_MENU_OPTIONS_FOR_ADMIN = {PLAY_RANDOM_GAME, SHOW_GAME_STATS, GOTO_ADMIN_MENU, LOG_OUT, EXIT};
    private static final String[] ADMIN_MENU_OPTIONS = {RETURN_TO_MAIN_MENU};
    ...
    private void showUserGameStats() {
        ...
        // TODO!!!
        view.displayErrorMessage("NOT IMPLEMENTED YET");
    }
}
